    ...
    <main>
      <section class="section-1 " id="section-1">
        ...
        <div class="container text-right main-text">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <h1>جهاز سيلكي للبشرة</h1>  
              <br>
              <h4>
                للشعور بالأنوثة الطاغية
              </h4>
              <br>
              <a class="shakeit btn primary-btn btn-primary btn-lg" href="{{ url('/product') }}" role="button" data-aos="zoom-out" data-aos-duration="1000" for="pink" id="btn-shaky"> اشترِ الآن </a>


            </div>
          </div>
              <a class="shakeit btn primary-btn btn-primary btn-lg mobileshow_dis btn-mobile" href="{{ url('/product') }}" role="button" for="pink" id="btn-shaky"> اشترِ الآن </a>
            </div>
        ...
        <div class="container text-center">
          ...
          <div class="row">
           ...
           <div class="col-md-5 text-first" data-aos="fade-left" data-aos-duration="600">
              ...
              <br>
              <h4>
                بإمكانك استعمال جهاز ليزر سيلكي سكن على جميع مناطق الجسم حتى الوجه و المنطقة الحساسة
              </h4>
              <br>
              <a class="shakeit btn primary-btn btn-primary btn-lg" href="{{ url('/product') }}" role="button" for="pink" id="btn-shaky"> اشترِ الآن </a>

           </div>
           <div class="col-md-7 img-responsive" data-aos="fade-right" data-aos-duration="600">
           <a href="{{ url('/product') }}" > <img src="{{ asset('assets/assets/pg-2_1.jpg', Request::secure()) }}" class="rounded image-pg-2-1 float-right" alt="image-pg-2"></a>
            <a href="{{ url('/product') }}" > <img src="{{ asset('assets/assets/pg-2_2.jpg', Request::secure()) }}" class="rounded image-pg-2-2 float-left" alt="image-pg-2"> </a>
           </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 img-responsive" >
              ...
              <form action="{{ url('/confirm') }}" method="post" enctype="multipart/form-data">
                ...
                <img src="{{ asset('assets/assets/product-1.jpg', Request::secure()) }}" class="image-pg-3-1" alt="image-pg-2">

              </label>

              <label class="pink-hidden"  data-aos="fade_in" data-aos-duration="1000" for="pink" id="pink">
                <img src="{{ asset('assets/assets/product-2.jpg', Request::secure()) }}" class="image-pg-3-2" alt="image-pg-2">
              </label>
            ...
            <div class="col-md-6 text-first text-right" data-aos="fade-left" data-aos-duration="1000">
              ...
              <hr>
                 ...
                 <div class="input-group">
                  ...
                  <span class="input-group-btn"><button class="btn btn-light value-control" type="button" data-action="minus" data-min="1"  data-target="qte"><i class="fa fa-minus"></i></button></span>
                  <input type="number" value="1" min="1" max="10" oninvalid="InvalidMsg(this);" onchange="this.setCustomValidity('')" class="form-control col-md-2 number_ltr" id="qte" style="width: 10px;" name="qte" required/>
                  <span class="input-group-btn"><button class="btn btn-light value-control" type="button" data-action="plus" data-max="10" data-target="qte"><i class="fa fa-plus"></i></button></span>
                </div> 
      ...
      <section class="section-4" id="section-4">
        <div class="container text-right" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          ...
          <div class="row">
            <form action="{{ url('/contact') }}" class="container first-form" method="post" enctype="multipart/form-data" style="width: 100%">
              @csrf
              <div class="form-row ">
                <div class="col">
                  <label for="name">إسمك</label>
                  <input type="text" class="form-control" name="name" id="name" required placeholder="أكتب أسمك">
                </div>
                <div class="col">
                  <label for="email">البريد الإلكتروني</label>
                  <input type="text" class="form-control" name="email" id="email" placeholder="أكتب بريدك الإلكتروني" required>
                </div>
              </div>
              <div class="form-group">
                <label for="message">رسالتك</label>
                <textarea class="form-control textarea" name="message" id="message" rows="3" required placeholder="أكتب رسالتك"></textarea>
              </div>
              <div class="col text-center">
                <button class="btn primary-btn btn-primary center btn-lg"  role="submit" id="btn-shaky"> إرسال</a>
                </div>
