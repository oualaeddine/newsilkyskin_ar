...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css"
          ...
          crossorigin="anonymous"/>
    <link rel="stylesheet" href="{{ asset('assets/css/style.css', Request::secure()) }}"> <!-- Meta Pixel Code -->
    <script>
        ...
        <div class="container text-right main-text">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <a class="shakeit btn primary-btn btn-primary btn-lg" href="{{ route('checkout.product') }}"
                       role="button"
                       data-aos="zoom-out" data-aos-duration="1000" for="pink" id="btn-shaky"> اشترِ الآن </a>
                </div>
            </div>
            <a class="shakeit btn primary-btn btn-primary btn-lg mobileshow_dis btn-mobile"
               href="{{ route('checkout.product') }}"
